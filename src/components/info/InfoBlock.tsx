  ...
  return (
    <div className="flex h-fit w-fit flex-col items-center">
      <a
        ...
        target="_blank"
        className="group rounded-xl bg-white px-4 py-4 shadow-inner shadow-black/0 transition-all hover:shadow-black/20 focus:shadow-black/20 active:shadow-black/40"
      >
